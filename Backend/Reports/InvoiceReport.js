  ...
  footer {
    ...
    <body>
      <header class="clearfix">
        ...
        <div id="project">
           <div><span>INVOICE NO</span><div style="font-size:13px; display:inline-block; font-weight:500;">IN-${InvoiceData.invoiceNumber}</div></div>
    ...
    ` 
          <tr>
            ...
            <tr>
              ...
              <td class="total">LKR : ${(Number(InvoiceData.advance)).toLocaleString('en-US')}</td>
            </tr>
            <tr>
        ...
        <div id="notices">
        <div style="font-weight: 400;color:#f56969; margin-bottom: 5px;">Materials release after the payment</div>

        <div style="font-weight: 500;color:black; margin-bottom: 1px;">Bank Details</div>
        <div class="notice">Bank : Sampath Bank</div>
         <div class="notice">Account No : 112257803973</div>
         <div class="notice">D.L.H.D.Y Dodanduwa</div>
         <div class="notice">Branch : Rajagiriya</div>
        </div>
      </main>
      <footer>
