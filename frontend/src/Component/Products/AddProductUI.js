...
class AddProductUI extends Component {
                                        ...
                                        <div style={{ "overflow": "auto", "height": "680px", "overflowX": "auto" }}>
                                            ...
                                            <div className={AccountCSS.form}>
                                                ...
                                                <Row>
                                                    <Col>
                                                        ...
                                                        <Form.Group className="mb-3" controlId="formBasicEmail">
                                                            ...
                                                            <Form.Control type="text" value={this.props.productName} onChange={this.props.changProductName} name="productName" />
                                                ...
                                                <Row>
                                                    ...
                                                    <JoditEditor value={this.props.productDiscription}
                                                        onChange={(content) => this.props.changproductDiscription(content)}
                                                        tabIndex={1}
                                                ...
                                                <Row>
                                                    ...
                                                    <Col>
                                                        ...
                                                        <Form.Group className="mb-3" controlId="formBasicEmail">
                                                            <Form.Label>Product Name</Form.Label>
                                                            <Form.Control type="text" onChange={this.props.changProductName} value={this.props.productName} name="productNames" />
                                                        ...
                                                        <div class="row g-1">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="card-body">
                                                                    ...
                                                                    <Button variant="primary" type="submits" style={{ "marginTop": "20px", "width": "80px", "fontSize": "smaller" }} onClick={() => this.props.cancelBaggage(obj._id, index)}>
                                                                        Cancel
                                                                    </Button>
