...
class invoice extends Component {
    ...
    onInvoiceDraftBtn(e) {
        e.preventDefault();
        const { companyName, invoiceNumber, companyID, invoiceTotal, invoiceDiscount, productID, productName,
            invoiceAdvanceAmount, datetoday, comAddressCity, comAddressNum, comAddressStreet, productObjectArrey } = this.state

        let invNumber = (invoiceNumber).split(" ");
    ...
    onMailSend(invoiceObject) {
        ...
        if (this.state.companyEmailAddress !== '') {
            ...
            const emailobject = {
                ...
                "invoiceNo": invoiceObject.invoiceNumber,
    ...
    invoiceNumberCreation() {
        ...
        if (lastObject) {
            ...
            let formattedNumber = invoiceNumber.toLocaleString('en-US', {
                minimumIntegerDigits: 4,
                useGrouping: false
            })

            this.setState({
                invoiceNumber: "IN - " + formattedNumber
            })
        } else {
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col>
                                                            ...
                                                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                                                ...
                                                                <Form.Control type="text" disabled={true} style={{ "textAlign": "center", "fontSize": "17px", "fontWeight": "700" }} value={this.state.invoiceNumber} name="date" />
